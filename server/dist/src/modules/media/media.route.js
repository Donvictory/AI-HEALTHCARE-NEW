 ...
 */
router.post("/upload/single", auth_middleware_1.protect, upload_middleware_1.uploadMedia.single("file"), mediaController.uploadSingle.bind(mediaController));
/**
 * @swagger
 ...
 *                             type: string
 */
router.post("/upload/multiple", auth_middleware_1.protect, upload_middleware_1.uploadMedia.array("files", 10), // Limit to 10 files
