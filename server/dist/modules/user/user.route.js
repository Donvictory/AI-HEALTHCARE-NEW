 ...
 */
router.post("/refresh-token", user_validator_1.refreshTokenValidator, validate_request_middleware_1.validateRequest, userController.refreshToken.bind(userController));
/**
 * @swagger
 * /api/v1/users/logout:
 *   post:
 ...
 */
router.post("/logout", auth_middleware_1.protect, userController.logout.bind(userController));
// Protected routes
